...
export class Package_requestRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.put(`${this.path}/approve/:id(\\d+)`, this.package_request.approvePackage_request);
    this.router.put(`${this.path}/reject/:id(\\d+)`, this.package_request.rejectPackageRequest);
